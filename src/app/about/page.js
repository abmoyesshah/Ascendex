    ...
    <section id="about" className="relative py-12 sm:py-16 lg:py-20 overflow-hidden bg-white">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 leading-tight">
          A team of SEO, AEO & GEO experts ready to help you
        </h2>
        <p className="text-gray-500 max-w-2xl mx-auto mt-3 sm:mt-4 text-sm sm:text-base leading-relaxed">
          Our multidisciplinary team ensures your brand is visible on search engines, answer boxes, and AI‑generated responses.
        </p>
      </div>

      {/* ... rest of the about page (image and stats cards) remains the same ... */}
