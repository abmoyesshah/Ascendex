      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_360px] gap-8 lg:gap-12 xl:gap-16 items-start">
          <div>
            ...
            <button className="bg-blue-600 hover:bg-blue-700 transition text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-sm sm:text-base">
              Apply Now
            </button>
          </div>
          ...
          <div className="lg:sticky lg:top-24">
            <div className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl lg:rounded-[28px] p-5 sm:p-6 lg:p-8 shadow-sm">
              ...
              <p className="text-gray-500 leading-7 text-xs sm:text-sm text-center mb-5 sm:mb-6 lg:mb-8">Lorem ipsum dolor sit amet...</p>
              <button className="w-full bg-blue-600 hover:bg-blue-700 transition text-white font-semibold py-3 sm:py-4 rounded-xl text-sm sm:text-base">
                Apply Now
              </button>
            </div>
          </div>
